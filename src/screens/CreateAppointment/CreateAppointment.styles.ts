...
import { IProvider } from './CreateAppointment';
...
export const ProviderContainer = styled(RectButton)<IProviderContainerProps>`
  /* as props do componente vem nas pros do componente  */
...
export const OpenDatePickerButon = styled(RectButton)`
  height: 46px;
...
export const Hour = styled(RectButton)<IHaurProps>`
  padding: 12px;
  background-color: ${(props) => (props.selected ? '#ff9000' : '#3e3b47')};
  border-radius: 10px;
  margin-right: 8px;
